Shader "Custom/Toon/ToonLightEdit"
{
    Properties
    {
        ...
        _ShadowColor ("ShadowColor", Color) = (0.0, 0.0, 0.0, 1) // Nouvelle propriété pour la couleur de l'ombre
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 _ShadowColor; // Nouvelle propriété pour la couleur de l'ombre
            float _SpecularStep;
            ...
            float4 frag(Varyings input) : SV_Target
            {
                ...
                //shadow color
                float3 shadowColor = _ShadowColor.rgb * (1 - shadowNL) * opacity;

                float3 finalColor = diffuse + ambient + specular + shadowColor;
